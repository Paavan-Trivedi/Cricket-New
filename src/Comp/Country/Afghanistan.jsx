...
export default function Afghanistan() {
  ...
  return (
    <>
      ...
      <NavLink to={"/Afghanistan"} ><button className="Btn" >All</button> </NavLink>
      ...
      <div className="players">
        {Players.filter((val) => {
          ...
          else if (val.player_country == "afghanistan-40" && val.player_name.toLowerCase().includes(search.toLowerCase())) {
            return val;
          }
